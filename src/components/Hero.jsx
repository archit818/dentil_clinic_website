        ...
        <div className="container h-100">
          <div className="row h-100 hero-text">
            <div
              ...
              style={{ maxWidth: '60%' }}
            >
              <h3 className="merriweather fs-24 text-white animate__animated animate__slideInDown animate__delay-1s" aria-label="10 Years of Dental Excellence">
                10 Years of Dental Excellence
              </h3>
              <h1 className="merriweather fs-48 mb-4 text-white animate__animated animate__slideInDown animate__delay-2s" aria-label="Main heading: Your Smile, Our Commitment">
                Your Smile, Our Commitment
              </h1>
              <p className="lato lead fs-18 lh-sm mb-7 text-white animate__animated animate__slideInRight animate__delay-3s" aria-label="Supporting text">
              ...
              <div className="animate__animated animate__slideInUp animate__delay-3s merriweather">
                <Link href="/book-appointment" className="btn btn-lg rounded">
                  Book Appointment
                </Link>
              </div>
            </div>
