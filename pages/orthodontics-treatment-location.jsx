...
const Orthodontics = () => {
  return (
    <Fragment>
      <Head>
        <title>Orthodontics | Dental Clinic</title>
        <meta name="description" content="Professional orthodontics treatment at Dental Clinic. Straighten your teeth and improve your smile with our advanced braces and clear aligner clinical procedures." />
      </Head>
      ...
      <main className="content-wrapper overflow-hidden">
          ...
          <div className="container pt-14 pb-14">
            <div className="row align-items-center">
              <div className="col-lg-5 mb-8 mb-lg-0">
                <figure className="rounded-4 overflow-hidden shadow-lg m-0">
                   <div className="position-relative" style={{ width: '100%', height: '400px' }}>
                    <Image 
                      src="https://dentals-clinic.netlify.app/img/services/orthodonitics.webp" 
              ...
              <div className="col-lg-6 offset-lg-1 text-center text-lg-start">
                <h1 className="merriweather display-1 text-white mb-3">Orthodontics</h1>
                ...
                <p className="lato fs-16 mt-6 mb-0 opacity-70">
                  <a href="/" className="text-white">Home</a> / <span className="text-white">Orthodontics</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container py-10 py-md-14">
            <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
              ...
              <div className="col-lg-6">
                <h2 className="merriweather display-4 mb-4">Orthodontics In Location</h2>
        ...
        <section className="wrapper bg-grays text-center">
          <div className="container py-10 py-md-12">
            <h2 className="merriweather display-5 mb-5">What is Orthodontics?</h2>
        ...
        <section className="wrapper bg-white">
          <div className="container py-10 py-md-16">
            <div className="heading mb-12">
              <h2 className="merriweather display-4 text-center">Benefits of Orthodontics</h2>
            </div>
        ...
        <section className="wrapper bg-gray">
          <div className="container py-14 py-md-16">
            <div className="heading text-center mb-12">
              <h2 className="merriweather display-4">Orthodontics Procedure</h2>
            </div>
            <div className="row justify-content-center">
              <div className="col-lg-10">
        ...
        <section className="wrapper bg-white">
          <div className="container py-14 py-md-16">
            <div className="heading text-center mb-12 d-flex flex-column align-items-center">
              ...
              <h2 className="merriweather display-4">Dental Clinic for Orthodontics</h2>
            </div>
        ...
        <OtherTreatments currentSlug="orthodontics-treatment-location" />
      </main>
    </Fragment>
  );
};
