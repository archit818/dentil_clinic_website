...
const RootCanalTreatment = () => {
  return (
    <Fragment>
      <Head>
        <title>Root Canal Treatment | Dental Clinic</title>
        <meta name="description" content="Expert root canal treatment at Dental Clinic. Save your natural teeth with our painless and advanced clinical procedures." />
      </Head>
      ...
      <main className="content-wrapper overflow-hidden">
            ...
            <div className="row align-items-center">
              <div className="col-lg-5 mb-8 mb-lg-0">
                <figure className="rounded-4 overflow-hidden shadow-lg m-0">
                  <Image 
                    src="https://dentals-clinic.netlify.app/img/services/root-canal-treatment.webp" 
                    alt="Root Canal Treatment Hero" 
                    width={600} 
                    height={400} 
                    objectFit="cover" 
                  />
              ...
              <div className="col-lg-6 offset-lg-1 text-center text-lg-start">
                <h1 className="merriweather display-1 text-white mb-3">Root Canal Treatment</h1>
                ...
                <p className="lato fs-16 mt-6 mb-0 opacity-70">
                  <a href="/" className="text-white">Home</a> / <span className="text-white">Root Canal Treatment</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container py-10 py-md-14">
            <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
              <div className="col-md-8 col-lg-6 position-relative">
                ...
                <figure className="rounded-4 overflow-hidden shadow-lg m-0">
                  <div className="position-relative" style={{ width: '100%', height: '400px' }}>
                    <Image 
                      src="https://dentals-clinic.netlify.app/img/services/root-canal-treatment.webp" 
                      alt="Root Canal Treatment In Location" 
                      layout="fill" 
                      objectFit="cover" 
                    />
                  </div>
              ...
              <div className="col-lg-6">
                <h2 className="merriweather display-4 mb-4">Root Canal Treatment In Location</h2>
        ...
        <section className="wrapper bg-grays text-center">
          <div className="container py-10 py-md-12">
            <h2 className="merriweather display-5 mb-5">What is Root Canal Treatment?</h2>
        ...
        <section className="wrapper bg-white">
          <div className="container py-14 py-md-16">
            <div className="heading mb-12">
              <h2 className="merriweather display-4 text-center">Benefits of Root Canal Treatment</h2>
            </div>
        ...
        <section className="wrapper bg-gray">
          <div className="container py-14 py-md-16">
            <div className="heading text-center mb-12">
              <h2 className="merriweather display-4">Root Canal Treatment Procedure</h2>
            </div>
            <div className="row justify-content-center">
              <div className="col-lg-10">
        ...
        <section className="wrapper bg-white">
          <div className="container py-14 py-md-16">
            <div className="heading text-center mb-12 d-flex flex-column align-items-center">
              ...
              <h2 className="merriweather display-4">Dental Clinic for Root Canal Treatment</h2>
            </div>
        ...
        <OtherTreatments currentSlug="root-canal-treatment-location" />
      </main>
    </Fragment>
  );
};
