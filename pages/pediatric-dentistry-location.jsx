...
const PediatricDentistry = () => {
  return (
    <Fragment>
      <Head>
        <title>Pediatric Dentistry | Dental Clinic</title>
        <meta name="description" content="Compassionate pediatric dentistry for children. We provide specialized dental care for infants, children, and adolescents in a friendly environment." />
      </Head>
      ...
      <main className="content-wrapper overflow-hidden">
          ...
          <div className="container pt-14 pb-14">
            <div className="row align-items-center">
              <div className="col-lg-5 mb-8 mb-lg-0">
                <figure className="rounded-4 overflow-hidden shadow-lg m-0">
                  <div className="position-relative" style={{ width: '100%', height: '400px' }}>
                    <Image 
                      src="https://dentals-clinic.netlify.app/img/services/paediatric-dentistry.webp" 
              ...
              <div className="col-lg-6 offset-lg-1 text-center text-lg-start">
                <h1 className="merriweather display-1 text-white mb-3">Pediatric Dentistry</h1>
                ...
                <p className="lato fs-16 mt-6 mb-0 opacity-70">
                  <a href="/" className="text-white">Home</a> / <span className="text-white">Pediatric Dentistry</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container py-10 py-md-14">
            <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                ...
                <figure className="rounded-4 overflow-hidden shadow-lg m-0">
                  <div className="position-relative" style={{ width: '100%', height: '400px' }}>
                    <Image 
                      ...
                      alt="Pediatric Dentistry In Location" 
                      layout="fill" 
                      objectFit="cover" 
                    />
                  </div>
              ...
              <div className="col-lg-6">
                <h2 className="merriweather display-4 mb-4">Pediatric Dentistry In Location</h2>
        ...
        <section className="wrapper bg-grays text-center">
          <div className="container py-10 py-md-12">
            <h2 className="merriweather display-5 mb-5">What is Pediatric Dentistry?</h2>
        ...
        <section className="wrapper bg-white">
          <div className="container py-14 py-md-16">
            <div className="heading mb-12">
              <h2 className="merriweather display-4 text-center">Benefits of Pediatric Dentistry</h2>
            </div>
        ...
        <section className="wrapper bg-gray">
          <div className="container py-14 py-md-16">
            <div className="heading text-center mb-12">
              <h2 className="merriweather display-4">Pediatric Dentistry Procedure</h2>
            </div>
            <div className="row justify-content-center">
              <div className="col-lg-10">
        ...
        <section className="wrapper bg-white">
          <div className="container py-14 py-md-16">
            <div className="heading text-center mb-12 d-flex flex-column align-items-center">
              <div className="d-flex align-items-center justify-content-center mb-3" style={{ width: '100%', maxWidth: '516px' }}>
              ...
              <h2 className="merriweather display-4">Dental Clinic for Pediatric Dentistry</h2>
            </div>
        ...
        <OtherTreatments currentSlug="pediatric-dentistry-location" />
      </main>
    </Fragment>
  );
};
