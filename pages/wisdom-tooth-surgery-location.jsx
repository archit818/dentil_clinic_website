...
const WisdomToothSurgery = () => {
  return (
    <Fragment>
      <Head>
        <title>Wisdom Tooth Surgery | Dental Clinic</title>
        <meta name="description" content="Expert wisdom tooth surgery at Dental Clinic. Removal of impacted wisdom teeth with advanced clinical procedures for your comfort and health." />
      </Head>
      ...
      <main className="content-wrapper overflow-hidden">
          ...
          <div className="container pt-14 pb-14">
            <div className="row align-items-center">
              <div className="col-lg-5 mb-8 mb-lg-0">
                <figure className="rounded-4 overflow-hidden shadow-lg m-0">
                   <div className="position-relative" style={{ width: '100%', height: '400px' }}>
                    <Image 
                      src="https://dentals-clinic.netlify.app/img/services/wisdom-tooth-surgery.webp" 
              ...
              <div className="col-lg-6 offset-lg-1 text-center text-lg-start">
                <h1 className="merriweather display-1 text-white mb-3">Wisdom Tooth Surgery</h1>
                ...
                <p className="lato fs-16 mt-6 mb-0 opacity-70">
                  <a href="/" className="text-white">Home</a> / <span className="text-white">Wisdom Tooth Surgery</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container py-10 py-md-14">
            <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                ...
                <figure className="rounded-4 overflow-hidden shadow-lg m-0">
                  <div className="position-relative" style={{ width: '100%', height: '400px' }}>
                    <Image 
                      ...
                      alt="Wisdom Tooth Surgery In Location" 
                      layout="fill" 
                      objectFit="cover" 
                    />
                  </div>
              ...
              <div className="col-lg-6">
                <h2 className="merriweather display-4 mb-4">Wisdom Tooth Surgery In Location</h2>
        ...
        <section className="wrapper bg-grays text-center">
          <div className="container py-10 py-md-12">
            <h2 className="merriweather display-5 mb-5">What is Wisdom Tooth Surgery?</h2>
        ...
        <section className="wrapper bg-white">
          <div className="container py-10 py-md-16">
            <div className="heading mb-12">
              <h2 className="merriweather display-4 text-center">Benefits of Wisdom Tooth Surgery</h2>
            </div>
        ...
        <section className="wrapper bg-gray">
          <div className="container py-14 py-md-16">
            <div className="heading text-center mb-12">
              <h2 className="merriweather display-4">Wisdom Tooth Surgery Procedure</h2>
            </div>
            <div className="row justify-content-center">
              <div className="col-lg-10">
        ...
        <section className="wrapper bg-white">
          <div className="container py-14 py-md-16">
            <div className="heading text-center mb-12 d-flex flex-column align-items-center">
              ...
              <h2 className="merriweather display-4 text-center">Dental Clinic for Wisdom Tooth Surgery</h2>
            </div>
            ...
            <div className="row gy-8 justify-content-center">
              {[
                ...
                <div className="col-lg-4 col-xl-3 col-md-6 mb-5" key={i}>
        ...
        <OtherTreatments currentSlug="wisdom-tooth-surgery-location" />
      </main>
    </Fragment>
  );
};
